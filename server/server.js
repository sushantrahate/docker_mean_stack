...
const uri = "mongodb://localhost:27017/dynoworld";
...
const Dyno = mongoose.model('dyno', DynoSchema);
...
app.post('/dynos', async function (req, res, next) {
  const { name } = req.body;
